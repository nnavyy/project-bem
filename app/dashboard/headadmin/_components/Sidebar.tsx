...
const MENU = [
  ...
  { href: "/dashboard/headadmin/logs",         label: "Log Aktivitas", icon: <IconList /> },
  { href: "/dashboard/headadmin/laporan",      label: "Laporan",       icon: <IconDoc /> },
  { href: "/dashboard/headadmin/blog",         label: "Blog",          icon: <IconEdit /> },
  { href: "/dashboard/headadmin/portofolio",   label: "Portofolio",    icon: <IconGrid /> },
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/10">
        ...
        <p className="mt-0.5 text-white font-semibold text-sm">Panel Headadmin</p>
      </div>
