...
export default function AdminOverviewPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      fetch("/api/headadmin/logs?pageSize=8").then((r) => r.json()), // Might need to just use a regular log endpoint if admin shouldn't see headadmin endpoint. For now, try fetching or skip if admin doesn't have permission.
    ])
      .then(([laporan, blogs, logsRes]) => {
  ...
  return (
    <main className="p-6 lg:p-8 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-white">Overview Admin</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {loading ? (
          ...
          <div className="col-span-1 sm:col-span-3 text-white/40 text-sm text-center py-12">
