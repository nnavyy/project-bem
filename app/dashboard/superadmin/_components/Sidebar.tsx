...
const MENU_MAIN = [
  ...
  {
    href: "/dashboard/superadmin/portofolio",
    label: "Portofolio",
    icon: <IconGrid />,
  },
];
...
const MENU_SUPER = [
  {
    href: "/dashboard/superadmin/mahasiswa",
    label: "Mahasiswa",
    icon: <IconStudents />,
  },
  {
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        {MENU_SUPER.map((item) => {
          ...
          return (
            ...
            >
              {item.icon}
              {item.label}
              {item.href === "/dashboard/superadmin/requests" && pendingCount > 0 && (
      ...
      <div className="px-4 py-4 border-t border-white/10">
        {user ? (
          <div className="mb-3 px-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-bold px-1 py-0.5 rounded bg-amber-500/20 text-amber-400">
                SA
              </span>
            </div>
        ...
        {/* Dashboard Umum button */}
        <Link
          href="/dashboard"
          className="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 transition-colors mb-2"
        >
