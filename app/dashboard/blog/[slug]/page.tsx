...
export default function BlogDetailPage() {
  ...
  return (
    <main className="bg-[#0f172a] text-white min-h-screen">
      ...
      <div className="relative z-20 max-w-3xl mx-auto px-6 pt-6 -mb-6 md:pt-10 md:-mb-10">
        <Link href="/dashboard/blog" className="inline-flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors bg-white/5 hover:bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm border border-white/5 w-fit">
